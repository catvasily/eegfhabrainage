...
def get_data_folders():
	...
	if 'ub20-04' in host:
		...
		out_root = data_root + '/ps_segments'
		cluster_job = False
	elif 'cedar' in host:
		data_root = '/project/6019337/databases/eeg_fha/release_001/edf'
		out_root = user_home + '/projects/rpp-doesburg/' + user + '/data/eegfhabrainage/ps_segments'
		cluster_job = True
	else:
		home_dir = os.getcwd()
		data_root = home_dir
		out_root = home_dir + '/ps_segments'
		cluster_job = False
...
if __name__ == '__main__': 
	...
	# RCH
	#source_scan_ids = ['7cd8be05-5286-4d65-bb5d-42031f131db8.edf']
	# Surrey
	source_scan_ids = ['4d11c693-aa53-449e-bded-a2dc13053353.edf']
	...
	slice_edfs(input_dir, output_dir, source_scan_ids = source_scan_ids, extract = 'PS')
